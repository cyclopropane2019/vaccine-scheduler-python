...
class Patient:
    ...
    def get(self):
        ...
        get_patients_details = "SELECT Salt, Hash FROM Patients WHERE Username = %s"
        try:
    ...
    def save_to_db(self):
        ...
        try:
            ...
            print("Error occurred when creating Patients")
    ...
    def upload_availability(self, d):
        ...
        try:
            ...
            print("Error occurred when updating patients availability")
            cm.close_connection()
        cm.close_connection()
